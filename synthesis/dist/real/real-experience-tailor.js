...
export class RealExperienceTailor {
    opts;
    constructor(opts) {
        this.opts = opts;
    }
    async tailor(matrix, companyIds) {
        ...
        const raw = invokeHeadlessAi('tailor', systemPrompt, userPrompt, this.opts);
        ...
        for (const id of companyIds) {
            const entry = raw[id];
            if (!entry)
                continue; // absent companyId → simply unmatched at merge time, not fatal here
...
//# sourceMappingURL=real-experience-tailor.js.map