...
export class RealPortfolioSynthesizer {
    opts;
    constructor(opts) {
        this.opts = opts;
    }
    async synthesize(matrix) {
        ...
        const raw = invokeHeadlessAi('synthesize', systemPrompt, userPrompt, this.opts);
...
//# sourceMappingURL=real-portfolio-synthesizer.js.map